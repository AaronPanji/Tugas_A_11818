...
model_directory = r'D:\KULIAH\Tugas_A_11818'
...
if os.path.exists(model_path):
    try:
        ...
        insulin = st.slider("Insulin (U/mL)", min_value=0, max_value=846, step=10)
    ...
    print("Flie 'rf_diabetes_model.pkl' tidak ditemukan di direktori")